                       ...
                       <div className='content-task' key={task.taskId}>
                           ...
                           <div className="content-bar">
                               <div className="bar-full">
                                   <div className="bar-progress movie" style={{ width: task.percentCompleted }}></div>
                               </div>
                                    ...
                                    {task.phases.map((phase, phaseIndex)=>{
                                       ...
                                       return(
                                           <li id={'phase-' + task.taskId + '-' + phaseIndex} key={'phase-' + task.taskId + '-' + phaseIndex}>
                                               <input className="inp-cbx" id={'phaseInput-' + task.taskId + '-' + phaseIndex} type="checkbox" defaultChecked={finished} />
